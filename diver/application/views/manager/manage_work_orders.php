...
function alertNow(str)
{
	...
	if(r)
	{
		$.ajax({url:"/btwdive/index.php/customer/work_order_email_alert/"+str,
...
endforeach;
    ...
    echo '<tr><td style="width:60%;cursor:pointer;text-decoration:underline" id="name'.$ad->PK_DIVER.'" onclick="newDiverPage('.$ad->PK_DIVER.')">'.$ad->DIVER_NAME.'</td><td class="numer" id="diver'.$ad->PK_DIVER.'">0</td><td><button onclick="alertNow('.$ad->PK_DIVER.')" class="btn">Alert Now</button></td></tr>';
    endforeach;
?>
</table>
