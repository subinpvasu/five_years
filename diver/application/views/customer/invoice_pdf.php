...
$temp = $temp .
                     ...
                     date ( "m/d/Y", strtotime ( $w->ENTRY_DATE ) ) .
                     '</div>';
}
$as ++;
...
if ($w->WORK_VALUE == 3 && $w->ADFD != '1900-01-01') {
$temp = $temp . '<div style="width:100%;float:left;font-family: sans-serif;font-size: 3mm;margin:1mm 0mm"><b style="width:55%;font-weight:normal;margin-right:5%">' . ucwords ( 
                strtolower ( $w->WORK_TYPE ) ) . '</b>............(Prior Replacement  &nbsp;&nbsp;' . date ( 
                "m/d/Y", 
                strtotime ( $w->ADFD ) ) . '=' . abs ( ceil ( ($w->DD / 30) ) ) . 'months)</div>';
} else {
$temp = $temp .
...
"m/d/Y", 
strtotime ( $w->ENTRY_DATE ) ) . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Discount ' . $w->DISCOUNT . '%</div>';
} else {
$temp = $temp .
...
$temp = $temp . "Summer Cleaning Dates(April 1st-Oct 31st):&nbsp;&nbsp;&nbsp;<b>" . ucwords ( strtolower ( $w->WORK_DESCRIPTION ) ) . "</b>";
} else {
$temp = $temp . "Winter Cleaning Dates(Nov 1st - March 31st):&nbsp;&nbsp;&nbsp;<b>" . ucwords ( 
strtolower ( $w->WORK_DESCRIPTION ) ) . "</b>";
}
...
$temp = $temp . '<div style="width:100%;float:left;font-family: sans-serif;font-size: 3mm;margin:1mm 0mm"><b  style="margin-right:23%;">Mechanical Services</b>............ ' . $w->ENTRY_DATE . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Discount ' . $w->DISCOUNT . '%</div>';
} else {
$temp = $temp .
			...
			<table class="slavetable" style="width: 94mm; text-align: center; vertical-align: top;">
				<tr>
					...
					<td style="vertical-align: top; width: 4mm"><img
						src="' . base_url () . 'img/dagger_pdf.png"
					...
					<td style="vertical-align: top;"><b
						...
						<table style="width: 100%; text-align: center; margin: 0px auto;">
							<tr>
								<td style=""><img src="' . base_url () . 'img/red.bmp"
								...
								<td style=""><img src="' . base_url () . 'img/blue.jpg"
									style="width: 10mm; height: 7mm;" /></td>
							</tr>
						</table></td>
					<td style="vertical-align: top; width: 4mm"><img
