...
if($history->type=='M'){echo 'Mech</td><a href="'.base_url ().'index.php/customer/mechanical_work_order/'.$history->workid.'" target="_blank" id="link'.$history->workid.'"></a><td  style="width:61%" colspan="2">'.$history->description.'</td>';}
if($history->type=='C'){echo 'Clean</td><a href="'.base_url ().'index.php/customer/cleaning_work_order/'.$history->workid.'" target="_blank" id="link'.$history->workid.'"></a><td  style="width:61%" colspan="2">'.$history->description.'</td>';}
echo '
