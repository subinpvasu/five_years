...
var masterdiver = $("#masterdiver").val();
		$.ajax({url: "<?php echo base_url();?>index.php/customer/total_commission_by_date/"+masterdiver,
            type: "post",
            data: {
                s_date: $("#search_datea").val(),
                e_date: $("#search_dateb").val()
...
<input type="hidden" id="masterdiver" value="<?php echo $diverid;?>"/>
            <div id="main" style="padding:50px 0 0 0;">
                ...
                <form id="respo-form" method="post">
                    ...
                    <h2 align="center">Completed Work Orders<!--<?php echo $diverid;?>-->
