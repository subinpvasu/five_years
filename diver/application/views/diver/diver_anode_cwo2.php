                            ...
                            <table>			
                                ...
                                foreach ($anodes as $anode) :
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                        $anode->VALUE == 3 ? print
                                                                '<td style="background-color:#262626;text-align: center;width: 40px"><input type="checkbox" class="chkbx" name="' . $anode->P . '" checked id="' . $anode->P . '" value="3" /></td>' : print
                                                                '<td style="background-color:#262626;text-align: center;width: 40px"><input type="checkbox" class="chkbx"  name="' . $anode->P . '"  id="' . $anode->P . '" value="3" /></td>';
                                        ?>
                                    </tr>        <?php
                                endforeach;
                                ?>
