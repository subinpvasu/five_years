...
$("#fieldsearch").keyup(function(){
	var qry = $(this).val();
	 $.ajax({url:"/btwdive/index.php/customer/searchAnodesEditing/",
			type:"post",
			 data: {
				query:qry	 
			 },
...
{
	$.ajax({url:"/btwdive/index.php/customer/displayAnodeList/",
		type:"post",
		 data: {
			anode:sbn	 
		 },
...
function modifyAnodeList()
{
	...
	$.ajax({url:"/btwdive/index.php/customer/modifyAnodeList/",
		type:"post",
		 data: {
            anode:$("#pk_anode").val(),
...
function addnewAnodeList(str)
{
	...
	$.ajax({url:"/btwdive/index.php/customer/addnewAnodeList/",
		type:"post",
		 data: {
