			...
			$page = (get_query_var('paged')) ? get_query_var('paged') : 1;
					  ...
					  $content_array = array();
					  $content_array['titlte'] = $post->post_title;
					  $content_array['post_link'] = $post->guid;
            	...
            	<!-- begin of slider -->
				<div id="main_div" style="width: 340px; background-color: #000; opacity: 0.6; height: 190px; padding-top: 20px !important;  border-radius: 10px;">
