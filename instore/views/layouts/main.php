...
<link rel="icon" type="image/png" href="<?php echo Yii::app()->request->baseUrl; ?>/images/myicon.png">
			...
			<div id="form_holder">
				<div class="page-ttl">
					...
					<form name="loginform" id="loginform"
						...
						<p>
							<div class="row rememberMe" style="margin-left: 0px;width:75%;">
							<input type="checkbox" value="1" id="LoginForm_rememberMe" name="LoginForm[rememberMe]" class="outtaHere" style="width:20px;float: left;
    left: 23px;
    position: absolute;">								<label for="LoginForm_rememberMe" style="float:left;margin-left: 18px;">Remember me next time</label>								<div style="display:none" id="LoginForm_rememberMe_em_" class="errorMessage"></div>							</div>
						</p>
						<div class="clear"></div>
			...
			<div class="container_12">
				<div class="grid_8 alpha">
					<?php  $this->widget('zii.widgets.CMenu',array(
							'items'=>array(
									//array('label'=>'Home', 'url'=>array('/user/login'),'visible'=>Yii::app()->user->isGuest),
									//array('label'=>'About', 'url'=>array('/site/page', 'view'=>'about')),
									//array('label'=>'Contact', 'url'=>array('/site/contact')),
									//array('label'=>'Login', 'url'=>'#', 'visible'=>Yii::app()->user->isGuest,'linkOptions' => array('class'=>'test','id'=>'login')),
									array('label'=>'Customers', 'url'=>array('/customers'), 'visible'=>!Yii::app()->user->isGuest),
									array('label'=>'Songs', 'url'=>array('/songs/admin'), 'visible'=>!Yii::app()->user->isGuest),									
									array('label'=>'Playlists', 'url'=>array('/playlists/admin'), 'visible'=>!Yii::app()->user->isGuest),	
									array('label'=>'Styles', 'url'=>array('/style/admin'), 'visible'=>!Yii::app()->user->isGuest),
									array('label'=>'Jingles', 'url'=>array('/jingles/admin'), 'visible'=>!Yii::app()->user->isGuest),
									array('label'=>'DB Export', 'url'=>array('/customers/exportdb'), 'visible'=>!Yii::app()->user->isGuest),
			...
			<div class="container_12 holder">
				<div class="grid_8 omega">
					<ul style="z-index: 99999999999;">
						<?php /*<li><a href="mailto:support@myinstoreradio.com">Support request</a>
						</li> */ ?>
					</ul>
				</div>
				<div class="clear"></div>
