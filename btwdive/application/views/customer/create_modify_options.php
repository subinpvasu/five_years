...
Project     : BTW Dive
Author      : Subin
Title      : Modify Options in the project
Description : Create/Modify options
-->
<script>
function updatePurposeList(sbn)
{
	$.ajax({url:base_url+"index.php/customer/updatePurposeList/",
		type:"post",
		data:{
qry:sbn
			},
...
$(document).ready(function(){
		...
		$.ajax({url:base_url+"index.php/customer/updateDataOption/",
			type:"post",
			data:{
				option:$("#category").val(),
			    rows:table_data
