...
Author      : Subin
Title      : modify diver
Description : Create/modify diver details.
-->
<script>
...
{
	$.ajax({url:base_url+"index.php/customer/updateDiverForm/",
		type:"post",
		 data: {
			diver:sbn
		 },
...
access=0;
	...
	$.ajax({url:base_url+"index.php/customer/modifyDiverForm/",
		type:"post",
		 data: {
...
access=0;
	...
	$.ajax({url:base_url+"index.php/customer/createDiverForm/",
		type:"post",
		 data: {
...
<tr><td style="text-align: right;">Allow Access<b style="font-weight: normal;color:yellow"></b></td><td><input type="checkbox" class="textbox" style="width:100%;" id="access"/></td><td></td><td></td></tr>
...
<tr><td style="text-align: right;">New Password<b style="font-weight: normal;color:yellow">*</b></td><td><input type="text" class="textbox" style="width:100%;" id="pass1"/></td><td></td><td></td></tr>
<tr><td style="text-align: right;">Confirm Password<b style="font-weight: normal;color:yellow">*</b></td><td><input type="text" class="textbox" style="width:100%;" id="pass2"/></td><td></td><td></td></tr>
