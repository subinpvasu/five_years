...
Description : Payment Details are listed here
-->
<style type="text/css">
	.redmark {
	color: #F00;
...
$.ajax({url:base_url+"index.php/customer/savePayment/",
		type:"post",
		data:{
...
//                             endforeach;endforeach;
  ...
  <tr>
      <td colspan="4" style="text-align: center;"><button class="btn" id="savebtn" onclick="paymentSave()">Save</button>
