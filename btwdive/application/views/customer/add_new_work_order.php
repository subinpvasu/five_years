...
Description : New work orders are added from this page.
-->
<script>
$(function() {
...
$(document).ready(function(){
    $("#newworkorder").click(function(){
    	...
    	else
        {
			...
			alert(2);
    		//setTimeout(function(){alert("Work Order Created Successfully.!");getout();},6000);
    	}
...
<?php 
$new_scheduled_date = date("Y_m_d",strtotime("$newdate"));
...
<iframe style="width:100%;border:none;overflow:auto;display: block;float:left;height:500px;" src="<?php echo base_url();?>index.php/customer/cleaning_frame/<?php echo $new_scheduled_date.'/'.$pkcustomer;?>/<?php echo $oldpk;?>/<?php echo $oldpk;?>" id="clean">
