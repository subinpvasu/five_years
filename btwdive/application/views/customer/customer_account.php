...
Description : Customer account shows the account details of thecustomer till date.
-->
...
function accountDialogBox(str)
{
	...
	$(document).ready(function() {
	    $("#modify").click(function() {
		  	   ...
		  	   $.ajax({url:base_url+"index.php/customer/update_ledger_table/",
		  			type:"post",
		  			 data: {
...
if(result=='Y'){
	...
	$(document).ready(function() {
	    $("#removeid").click(function() {
		  	...
		  	if(conf==true){
		  	   $.ajax({url:base_url+"index.php/customer/remove_ledger_table_row/",
		  			type:"post",
		  			 data: {
			  		ledgerkey : $('#ledgerkey').val()
...
function getledgerdetails(str)
{
	...
	xmlhttp.open("POST",base_url+"index.php/customer/get_ledger_details/"+str,true);
	xmlhttp.send();
}
