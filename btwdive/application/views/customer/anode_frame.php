...
Author      : Subin
Title      : Anode frame
Description : Anode work order added from this frame @add new work order.
-->
<script>
$(function() {
...
if($anode->ANODE_TYPE=='')
{
    $type_description = $anode->DESCRIPTION;
}
else
{
    $type_description = $anode->ANODE_TYPE;
}
echo '
<tr>
...
<td>
<textarea id="type'.$anode->PK_VESSEL_ANODE.'">'.$type_description.'</textarea>
<!--<input type="text" name="" id="type'.$anode->PK_VESSEL_ANODE.'"  value="'.$anode->DESCRIPTION.'" class="textbox" style="width:auto;"/>-->
</td>
<td><input type="text" name="" id="date'.$anode->PK_VESSEL_ANODE.'" value="'. $changed_date.'" class="textbox date" style="width:auto;"/></td>
