...
Project     : BTW Dive
Author      : Subin
Title      : Modify Cleaning
Description : Create/modify cleaning services from here.
-->
<script>
function updateCleaningOption(str)
{$("#servicenumber").val(str);
	$.ajax({url:base_url+"index.php/customer/updateCleaningOption/",
		type:"post",
		 data: {
            clean:str
				 },
...
alert("No Service Selected");exit;
	...
	$.ajax({url:base_url+"index.php/customer/updateHullcleanOption/",
		type:"post",
		 data: {
...
alert("Please Complete the form");exit;
	...
	$.ajax({url:base_url+"index.php/customer/createHullcleanOption/",
		type:"post",
		 data: {
...
alert("No Service Selected");
			exit;}
$.ajax({url:base_url+"index.php/customer/removeHullcleanOption/",
	type:"post",
	data:{
hull:$("#servicenumber").val()
		},
