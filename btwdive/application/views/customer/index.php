...
Author      : Subin
Title      : INDEX
Description : Index page of the BTW Dive management system.
-->
<?php
...
function displayCustomerByNameOrBoat(sbn,str)
{
	...
	loadAJAX().onreadystatechange=function()
	  ...
	  {
	  case 1:
		  xmlhttp.open("POST",base_url+"index.php/customer/ajaxCusomerListCustomer/"+sbn,true);
		  break;
	  case 2:
		  xmlhttp.open("POST",base_url+"index.php/customer/ajaxCusomerListAccount/"+sbn,true);
		  break;
	  case 3:
		  xmlhttp.open("POST",base_url+"index.php/customer/ajaxCusomerListInactive/"+sbn,true);
		  break;
	  case 4:
		  xmlhttp.open("POST",base_url+"index.php/customer/ajaxCusomerListWork/"+sbn,true);
		  break;
	  case 5:
		  xmlhttp.open("POST",base_url+"index.php/customer/ajaxCleaningWork/"+sbn,true);
		  break;
	  case 6:
		  xmlhttp.open("POST",base_url+"index.php/customer/ajaxAnodeWork/"+sbn,true);
		  break;
	  case 7:
		  xmlhttp.open("POST",base_url+"index.php/customer/ajaxMechanicalWork/"+sbn,true);//ajaxCompleteWork
		  break;
	  case 8:
		  xmlhttp.open("POST",base_url+"index.php/customer/ajaxCompleteWork/"+sbn,true);//ajaxCompleteWork
		  break;
	  case 9:
		  xmlhttp.open("POST",base_url+"index.php/customer/ajaxAddNewWork/"+sbn,true);//ajaxCompleteWork
		  break;
	  case 10:
		  xmlhttp.open("POST",base_url+"index.php/customer/ajaxIndividualInvoices/"+sbn,true);
		  break;
	  case 11:
		  xmlhttp.open("POST",base_url+"index.php/customer/ajaxRestoreInvoices/"+sbn,true);
		  break;
	  case 12:
		  xmlhttp.open("POST",base_url+"index.php/customer/ajaxDeleteInvoices/"+sbn,true);
		  break;
	  case 13:
		  xmlhttp.open("POST",base_url+"index.php/customer/ajaxVoidInvoices/"+sbn,true);
		  break;
	  case 14:
		  xmlhttp.open("POST",base_url+"index.php/customer/useforotheruse/"+sbn,true);//not used any where
		  break;
	  case 15:
		  xmlhttp.open("POST",base_url+"index.php/customer/ajaxCredits/"+sbn,true);//credits
		  break;
	  case 20:
		  xmlhttp.open("POST",base_url+"index.php/customer/ajaxRestoreWorkOrder/"+sbn,true);//used for the void work order display.
		  break;
		  default:
			  break;
	  }
...
document.getElementById("12").style.width="18%";
document.getElementById("13").style.width="19%";
document.getElementById("23").style.width="17%";
...
document.getElementById("12").style.left="19.5%";
document.getElementById("13").style.left="38%";
document.getElementById("23").style.left="57.5%";
document.getElementById("23").style.top="50px";
...
case 6:
	...
	document.getElementById("23").setAttribute('onclick','redirectPerfect("'+url+'index.php/customer/create_modify_mwos/")');
...
$("#core").keyup();
		...
		xmlhttp.open("POST",base_url+"index.php/customer/deleteCurrentInvoice/"+str,true);
		xmlhttp.send();
...
$("#core").keyup();
	...
	xmlhttp.open("POST",base_url+"index.php/customer/restoreCurrentInvoice/"+str,true);
	xmlhttp.send();
}
...
xmlhttp.open("POST",base_url+"index.php/customer/voidCurrentInvoice/"+str,true);
xmlhttp.send();
}
function repairCommission()
{
	 ...
	 $(document).ready(function(){
		...
		{
			removeDialogBox('maskid','dialogsid');
			$.ajax({url:base_url+"index.php/customer/repairCommission/",
				type:"post",
				data: {
wonumber:wonum
				},
...
$(document).ready(function(){
	$("#getaway").click(function(){
		...
		$.ajax({url: base_url+"index.php/customer/RemoveSessionStatus/",
...
<body
	...
	<input id="whoeverloggedin" type="hidden" value="<?php echo $this->session->userdata('logger');?>"/>
	<div  style="text-align:right"><input type="button" id="getaway" style="text-transform:uppercase" value="logout" class="btn"/></div>
	<div id="path" style="text-align:right"></div>
...
<input type="hidden" id="url" value="<?php echo base_url();?>"/>
		...
		<div id="body" style="width: 100%; position: relative; top: 150px;">
			...
			<button id="1" class="button cat1 sup" onclick="generate_menu_button(this.id)">customer</button>

			<button id="2" class="button cat2" onclick="generate_menu_button(this.id)">work order</button>

			<button id="3" class="button cat3 sup" onclick="generate_menu_button(this.id)">invoicing</button>

			<button id="4" class="button cat4 sup" onclick="generate_menu_button(this.id)">reports</button>

			<button id="5" class="button cat5 sup" onclick="generate_menu_button(this.id)">internal setup</button>

			<button id="6" class="button cat6 sup" onclick="generate_menu_button(this.id)">extra</button>
...
<button class="button cat7 "  onclick='redirectPerfect("<?php echo base_url();?>index.php/customer/manage_work_orders/")'>Phase 2 - Work Distribution</button>

<button class="button cat8 sup "  onclick='redirectPerfect("http://<?php echo $_SERVER['SERVER_NAME'];?>/diver/index.php/customer/diver_login/")'>diver login</button>

<button class="button cat9 sup "   onclick='redirectPerfect("<?php echo base_url();?>invoice")'>past invoice database</button>

<button class="button cat0 sup "   onclick='redirectPerfect("<?php echo base_url();?>index.php/customer/display_customer_logout")'>outstanding balances log</button>

<button style="margin-top:50px;" class="button  sup "  onclick='redirectPerfect("<?php echo base_url();?>index.php/customer/newsletterprogram/")'>News letter program</button>
