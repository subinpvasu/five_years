...
Description : Cleaning servicesa re added to profile from this page.
-->
<div class="content">
...
$(document).ready(function(){
	$('#hull_clean').change(function(){
		$.ajax({url:base_url+"index.php/customer/show_popup",
...
function getDetailsFromYearlyAjax(str)
{
	...
	xmlhttp.open("POST",base_url+"index.php/customer/ajaxWinterUpdate/"+str,true);
	xmlhttp.send();
}
