...
Description : Customer Banner provides the top links present in the profile creation pages.
-->
...
<ul class="list">
<li><a id="page_home" href="<?php echo base_url();?>index.php/customer/customer_registration/<?php echo $this->session->userdata('customerid');  ?>" style="color:#E6B522;font-weight:bold;text-transform:uppercase;" id="user">Customer</a></li>
...
<?php if(!is_numeric($this->session->userdata('customer_number')))
{
   // echo '<script>document.getElementById("page_home").click();</script>';
}
?>