...
Project     : BTW Dive
Author      : Subin
Title      : Mechanical work orderupdateswith comments,not completes
Description : Mechanical work orderupdateswith comments,not completes
-->
<!DOCTYPE html>
<html>
<head>
            ...
            function update_comments()
    {
     ...
     //  var a=$("#comment").val();
      // alert(a);
        $.ajax({url: "/btwdive/index.php/customer/update_diver_comments/",
                type: "post",
                data: {
