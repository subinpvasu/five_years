...
Project     : BTW Dive
Author      : Subin
Title      : Add new anode work order
Description : Anode work order will be added from here.
-->
<!DOCTYPE html>
<html>
<head>
...
<script type="text/javascript">
            function completeWorkOrder(str,sbn)
            {
                ...
                if(andid.length>1){
                    $.ajax({url:"/btwdive/index.php/customer/addAnodeWorkDiver/",
                        type:"post",
                        data: {
				    anodes:andid,
...
foreach ( $anodes as $anode ) :
    ?>
        <tr>
							<td><?php echo $anode->ANODE_TYPE;?> </td>
