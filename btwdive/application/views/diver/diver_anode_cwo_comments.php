...
Project     : BTW Dive
Author      : Subin
Title      : Complete Anode work orders.
Description : Anode work order completes here from diver end.
-->
<!DOCTYPE html>
<html>
<head>
	...
	<input type="hidden" id="msgsms" value="a"/>
		...
		<div id="headerbtns">
            ...
            <div>
					...
					<textarea  tabindex="15" id="comment" name="comments" onchange="messageChanged()"><?php echo $comments;?></textarea>
			...
			<div>
                            <button name="s"  onclick="window.location='<?php echo base_url();?>index.php/customer/diver_anode_cwo4/<?php echo $pkwork;?>'" type="button" >Back</button>
		...
		<div style="bottom: 0px; position: absolute; width: 93%; text-align: center;font-weight: bold;margin-bottom:-150px;"><br/>BTW
		Dive © 2014</div>
	</div>
