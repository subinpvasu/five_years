...
//        graphSize.height = (screenHeight*13.02083333333333)/100;
    ...
    function makeClientDataString(returnObj){
        ...
        var link = '<?php  echo '/';?>'+"reports.php?id="+clientId+"&type=TO";
   ...
   function loadSpendGraph(obj,returnObj,graphSize){
        ...
        if(calculatedValue >0){
            anchorImg = "<?= '/' ?>"+"images/anchor_image_pink.png";
        }else{
            anchorImg = "<?= '/' ?>"+"images/anchor_image_green.png";
        }
        var data = [{
                "displayValue":returnObj.ppcSpendCurrentMonth+" "+thisMonthShort,
                "anchorImageUrl":"<?= '/' ?>"+"images/anchor_image.png",
...
//        });    
    ...
    function loadColumnGraph(objectId,graphSize,numPrefix,lMonth,cMonth,val1,val2,val3){
        ...
        if(0 < val3){
            ...
            maxInTwo = val2/100;
            chartBgImage = "<?= '/' ?>"+"images/up_arrow.png";
        }else if(0 > val3){
            dispVal = val3;
            displayColour = lessColour;
            maxInTwo = val1/100;
            chartBgImage = "<?= '/' ?>"+"images/down_arrow.png";
        }else{
            dispVal = val3;
            displayColour = lessColour;
            maxInTwo = val1/100;
                                ...
                                "items": [
                                    {
                                        "id": "label",
                                        "type": "image",
                                        "url": "<?= '/' ?>"+"images/anchor_image_pink.png",
                                        "fillcolor": "#000000",
//                                        "fillcolor": "#6baa01",
                                        "x" : "$chartCenterX - 65",
                                        "y": "$chartEndY-20",
