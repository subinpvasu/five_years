    ...
    <div id="newReport" style="display: none;">
        ...
        <div style="width: 99%;margin: 0 auto;">
            <div class="daily_report_head" style="">
                <div style="width:9.4%;">Customer</div>
                <div style="width:15%;">Visitors to date</div>
                <div style="width:15%;">CPC</div>
                <div style="width:15%;">Spend</div>
                <div style="width:14.9%;">Daily Budget</div>
...
//        $(obj).find(".user-data").height(100);
//        $(obj).find(".user-data").width(115);
//        $(obj).find(".user-data").height((screenHeight*13.02083333333333)/100);
//        $(obj).find(".user-data").width((screenWidth*8.711566617862372)/100);
        var graphSize = {};
        graphSize.width = "198";
        graphSize.height = "130";
//        graphSize.width = (screenWidth*14.64128843338214)/100;
//        graphSize.height = (screenHeight*13.02083333333333)/100;
    ...
    function loadVisitorsAngularGraph(obj,returnObj,graphSize){
        var objectAngularId = makeGraphDiv(obj);
    ...
    function loadConversionsAngularGraph(obj,returnObj,graphSize){
        var objectAngularId = makeGraphDiv(obj);
        var lowerLimit = (returnObj.adwordsConversionsLastMonth).replace(/,/g , "");
        var upperLimit = (returnObj.adwordsConversionsCurrentMonth).replace(/,/g , "");
        var dataValue = (lowerLimit/upperLimit)*100;
        var displayValue = (lowerLimit/upperLimit)*100;
        loadAngularGraph(objectAngularId,graphSize,lowerLimit,upperLimit,dataValue,displayValue,"Expected "+returnObj.percentOnLastMonthAtCurrentRate);
   }
   
    function loadDailyBudgetBarGraph(obj,returnObj,graphSize){
        var objectId = makeGraphDiv(obj);
    ...
    function loadCPCGraph(obj,returnObj,graphSize){
        ...
        loadColumnGraph(objectId,graphSize,"",prevMonth,thisMonth,returnObj.cpcLastMonth,returnObj.cpcCurrentMonth);
    }
    ...
    function loadCPAGraph(obj,returnObj,graphSize){
        ...
        loadColumnGraph(objectId,graphSize,"",prevMonth,thisMonth,returnObj.ppcCpaLastMonth,returnObj.ppcCpaCurrentMonth);
    }
   ...
   function loadSpendGraph(obj,returnObj,graphSize){
        ...
        var data = [{
                ...
                "anchorImageUrl":"<?= SITE_URL ?>"+"images/anchor_image.png",
...
//        });    
    ...
    function loadColumnGraph(objectId,graphSize,numPrefix,lMonth,cMonth,val1,val2){
        var firstColumnColour = "00D7FE";
        var middleColumnColour = "FFFFFF";
        var lessColour = "8BBA00";
        ...
        if(val1 < val2){
            dispVal = (val2-val1).toFixed(2);
            displayColour = moreColour;
            maxInTwo = val2/100;
            chartBgImage = "<?= SITE_URL ?>"+"images/up_arrow.png";
        }else{
            dispVal = (val1 - val2).toFixed(2);
            displayColour = lessColour;
            maxInTwo = val1/100;
            chartBgImage = "<?= SITE_URL ?>"+"images/down_arrow.png";
        }
        FusionCharts.ready(function () {
