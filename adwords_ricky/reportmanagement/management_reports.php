...
<input type="hidden" id="range" value="<?php echo $_REQUEST['range'];?>"/>
<div class="report-container">
	<div class="page-header"><h1><b id="report_name"></b></h1>
	...
	<div class="report-div-one">
			...
			<div class="report-details2">
				<form action='' method ='get' class='reportForm' id="rangeform">
					<input type='hidden' name='account' value='<?php echo $_REQUEST['account'];?>' />
					<div><span class="txtcolor2">Select</span> Date Range&nbsp;:&nbsp;	</div>
					<div><select name='range' id="" onchange='document.getElementById("rangeform").submit();'>
						<option <?php if($_REQUEST['range']==7){echo 'selected';}?> value="7">7 Days Vs Last 7 Days</option>
						<option <?php if($_REQUEST['range']==14){echo 'selected';}?> value="14">14 Days Vs Last 14 Days</option>
						<option <?php if($_REQUEST['range']==30){echo 'selected';}?> value="30">30 Days Vs Last 30 Days</option>
						</select>
					</div>
					<div></div>
				</form>
    ...
    <div style="width:100%;" id="daily_report_view" >
        ...
        <div class="immediate-inner">
            <div class="daily_report_head" style="">
                <div style="width:15%;">Campaign</div>
                <div style="width:17%;">Visitors to Date</div>
                <div style="width:17%;">CPC</div>
                <div style="width:17%;">Spend</div>
                <div style="width:17%;">Conversions</div>
                <div style="width:16.6%;">CPA</div>
            </div>
            <div class="singleLine" style="display: none;">
                <div class="user-data" style="width:15%;">
                    <h4 style="">Manager Name</h4>
                    <!-- <h5 style="">Client Name</h5> -->
                    <h6 style="">Budget</h6>
                    <a style="font-size:11px;font-family:Gibson-SemiBold;font-weight:bold;display:none;" id="analysis_link" target="_blank"
                     href="managementReports.php?account=11">Campaign Analysis</a>
                </div>
...
<script type="text/javascript">
    ...
    var DISPLAY = "display";
    var DAILY_REPORT = "Campaign Analysis";
    ...
    var code = {GBP:"£",USD:"US$",EUR:"€",CAD:"CA$",MAD:"MAD",NOK:"kr",BRL:"R$",DKK:"kr.",SAR:"SAR",AUD:"AU$",HKD:"HK$",TRY:"TRY"};
    var thisMonth;
    var prevMonth;
    var thisMonthShort;
    var prevMonthShort;
...
default  :
	...
	break;
       ...
       // $("#report_name").text(DAILY_REPORT+makeClientNameString());
...
//        alert(2);
    ...
    function ajaxReadReports(report,obj,secondObj,mainObj){
        ...
        postingobj.date_range = $("#range").val()==''? 7 : parseInt($("#range").val());
        }
        catch(e){}
    ...
    */
    function makeDailyReports(obj,returnObj){
     ...
     //   $("#report_name").text(DAILY_REPORT+" -- "+makeClientNameString(returnObj));
        $("#report_name").text(DAILY_REPORT);
        var clientData = makeClientDataString(returnObj);
       // $(obj).find(".user-data h5").html(clientData);
        $(obj).find(".user-data h6").text("Budget "+code[returnObj.currencyCode]+" "+returnObj.budget);
//         if(!isNaN(parseInt($("#account").val())))
//         {$("#analysis_link").css("color","red");}

       //$(obj).find(".user-data a").html("Campaign Analysis");
        var graphWidth;
...
//        graphSize.height = (screenHeight*13.02083333333333)/100;
    ...
    function makeClientNameString(returnObj){
               var dataString = returnObj.clientName;
               return dataString;
    }
    ...
    function loadVisitorsAngularGraph(obj,returnObj,graphSize){
        var objectAngularId = makeGraphDiv(obj,"17%");
    ...
    function loadConversionsAngularGraph(obj,returnObj,graphSize){
        var objectAngularId = makeGraphDiv(obj,"16.6%");
    ...
    function loadDailyBudgetBarGraph(obj,returnObj,graphSize){
        var objectId = makeGraphDiv(obj,"17%");
                                ...
                                "items": [
                                    {
                                        "id": "label",
                                        "type": "text",
                                        "text": upperLimit+thisMonthShort,
                                        "fillcolor": "#000000",
//                                        "fillcolor": "#6baa01",
                                        "x" : "$chartCenterX+55",
                                        "y": "$chartEndY - 60",
                                ...
                                "items": [
                                    {
                                        "id": "label",
                                        "type": "text",
                                        "text": lowerLimit+prevMonthShort,
                                        "fillcolor": "#000000",
//                                        "fillcolor": "#6baa01",
                                        "x" : "$chartCenterX - 55",
                                        "y": "$chartEndY - 60",
