...
class Constants {
    ...
    public static $ADWORD_USER_TABLE_NAME = "adword_user";
    ...
    public static $PROSPECT_DAILY_REPORT_TABLE_NAME = "prospect_daily_report";
    public static $PROSPECT_SUMMERY_REPORT_TABLE_NAME = "prospect_summery_report";
