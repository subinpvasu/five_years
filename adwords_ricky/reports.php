...
$(document).ready(function(){
 ...
 <?php if($type=='CRR'){ ?> conversionRateByHourandDay();   <?php  } ?>
  
});

        function getAdLabelReport(){
            var alr_type = $("#alr_type").val();
            
            $.post('servicefiles/alr_reports.php',{alr_type:alr_type,id:<?php echo $id; ?>},function(data){
