...
<tr bgcolor ="<?php echo $color_4 ;  ?>">
	<td><?php echo $main->splitString($type[0],15); ?>&nbsp;</td>
...
<tr bgcolor ="<?php echo $color_4 ;  ?>">
	<td><?php echo $main->splitString($type[1],15); ?>&nbsp;</td>
...
<tr bgcolor ="<?php echo $color_4 ;  ?>">
	<td><?php echo $main->splitString($type[2],15); ?>&nbsp;</td>
...
<tr bgcolor ="<?php echo $color_4 ;  ?>">
	<td><?php echo $main->splitString($type[3],15); ?>&nbsp;</td>
