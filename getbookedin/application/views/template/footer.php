          ...
          <div class="row">
            <div class="hs_footer_about_us">
              <div class="col-lg-3 col-md-4 col-sm-12 col-md-12 col-sm-12">
                ...
                <a href="index-2.html"><img src="<?php echo $this->config->item('base_url'); ?>/assets/images/logo.png" alt="logo" width="180" height="41" /></a> </div>
...
<div class="hs_copyright"> Powered by vBridge.co.uk</div>