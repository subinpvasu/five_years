...
<!--    </div>-->
    ...
    <div id="user" class="tab-content <?php echo $hidden; ?>">
        <form class="row-fluid"  name="profile-form" id="profile-form">
...
<!--                <legend>--><?php //echo $this->lang->line('system_login'); ?><!--</legend>-->
                ...
                <input type="password" id="password" class="span9" />

                <label for="retype-password"><?php echo $this->lang->line('retype_password'); ?></label>
                <input type="password" id="retype-password" class="span9" />

                <br>

                <button type="button" id="user-notifications" class="btn" data-toggle="button" style="display: none;">
            ...
            <fieldset class="span5 miscellaneous-wrapper">
                ...
                <input type="text" id="uploadFile"  placeholder="Choose File" disabled="disabled" value="sample" class="span9" />

                <div class="fileUpload btn btn-primary">
                    <span>Upload</span>
                    <input name ="uploadBtn" id="uploadBtn" type="file" class="upload" />
                </div>

                <label for="header_back_color"><?php echo $this->lang->line('header_back_colour'); ?></label>
                <input type="text" id="header_back_color" class="color span9"  />

                <label for="header_color"><?php echo $this->lang->line('header_colour'); ?></label>
                <input type="text" id="header_color" class="color span9" />

                <label for="header_caption"><?php echo $this->lang->line('header_caption'); ?></label>
                <input type="text" id="header_caption"  class="span9"  />

                <label for="footer_back_color"><?php echo $this->lang->line('footer_back_colour'); ?></label>
                <input type="text" id="footer_back_color" class="color span9" />

                <label for="description"><?php echo $this->lang->line('description'); ?></label>
                <textarea id="description" class="span9" rows="3"></textarea>

                <br>
                <br>

                <!--                <button type="button" class="save-header btn btn-primary ">-->
                <!--                    --><?php //echo $this->lang->line('save').' Header'; ?>
                <!--                </button>-->


                <button type="button" class="save-settings btn btn-primary ">
                    <?php echo $this->lang->line('save'); ?>
                </button>
...
<!--                </script>-->
<!---->
<!--                <input type="text" id="uploadFile"  placeholder="Choose File" disabled="disabled" value="sample" />-->
<!---->
<!--                <div class="fileUpload btn btn-primary">-->
<!--                    <span>Upload</span>-->
...
<!--                </div>-->
<!---->
<!--                <label for="header_color">--><?php //echo $this->lang->line('header_back_colour'); ?><!--</label>-->
<!--                <input type="text" id="header_color" class="color" />-->
<!---->
<!--                <br>-->
<!--                <br>-->
<!---->
