...
<script type="text/javascript">    
    var GlobalVariables = {
        ...
        'appointmentDuration'   : <?php echo json_encode($appointment_duration); ?>,
        'user'                  : {
            'id'        : <?php if(is_numeric($user_id)) { echo $user_id;} else echo '""'; ?>,
    ...
    $(document).ready(function() {
        AdminuserBackendCalendar.initialize(true);
    });
</script>
    ...
    <div id="calendar-toolbar">
        <div id="calendar-filter">
            <label for="select-filter-item">
                <?php echo $this->lang->line('admin_url'); ?>
            </label>
        ...
        <div id="calendar-actions">
            <div class="btn-group">
                ...
                <?php if (($role_slug == DB_SLUG_ADMIN_USER || $role_slug == DB_SLUG_PROVIDER)
        ...
        <form class="form-horizontal">
            <fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select id="select-service" class="required span4" style="display: none">
                            <?php 
...
<!--                    </div>-->
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="start-datetime" readonly style="background-color: #FFF;" />
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="end-datetime" readonly style="background-color: #FFF;" />
                    </div>
                </div>
            ...
            <fieldset class="row-fluid">
                <legend>
                    ...
                    <button id="new-customer" class="btn btn-mini"  style="display: none;"
