<script type="text/javascript"
        src="<?php echo $base_url; ?>/assets/js/adminuser_backend_user.js"></script>

<!--<script type="text/javascript"-->
<!--        src="--><?php //echo $base_url; ?><!--/assets/js/backend_users_admins.js"></script>-->
<script type="text/javascript"
        src="<?php echo $base_url; ?>/assets/js/adminuser_backend_users_provider.js"></script>
<!--<script type="text/javascript"-->
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        AdminUserBackendUser.initialize(true);
    });
</script>
...
<div id="users-page" class="row-fluid">
    ...
    <ul class="nav nav-tabs">
        <!--        <li class="admins-tab tab "><a>--><?php //echo $this->lang->line('admins'); ?><!--</a></li>-->
        <li class="adminuser-tab tab active"><a><?php echo $this->lang->line('admins'); ?></a></li>
    ...
    // ---------------------------------------------------------------------
    ?>
    <div id="adminuser" class="tab-content" >
        <div id="filter-adminuser" class="filter-records column span4" >
            <form class="input-append" style="display: none;">
                <input class="key span12" type="text" />
                <button class="filter btn" type="submit" title="<?php echo $this->lang->line('filter'); ?>">
                    <i class="icon-search"></i>
                </button>
        ...
        <div class="details column span7">
            <div class="btn-toolbar span5">
                <div class="add-edit-delete-group btn-group">
<!--                    <button id="add-adminuser" class="btn " disabled="disabled">-->
<!--                        <i class="icon-plus icon-white"></i>-->
<!--                        --><?php //echo $this->lang->line('add'); ?>
<!--                    </button>-->
                    <button id="edit-adminuser" class="btn btn-primary" disabled="disabled">
                        <i class="icon-pencil"></i>
                        <?php echo $this->lang->line('edit'); ?>
                    </button>
                    <button id="delete-adminuser" class="btn" disabled="disabled">
                        <i class="icon-remove"></i>
                        <?php echo $this->lang->line('delete'); ?>
                    </button>
                </div>
                ...
                <div class="save-cancel-group btn-group" style="display:none;">
                    <button id="save-adminuser" class="btn btn-primary">
                        <i class="icon-ok icon-white"></i>
                        <?php echo $this->lang->line('save'); ?>
                    </button>
                    <button id="cancel-adminuser" class="btn">
                        <i class="icon-ban-circle"></i>
                        <?php echo $this->lang->line('cancel'); ?>
                    </button>
                </div>
...
<!--                <div class="display-details ">--><?php //echo $this->lang->line('details'); ?><!--</div>-->
<!--                <div class="display-working-plan current">--><?php //echo $this->lang->line('working_plan'); ?><!--</div>-->
            </div>
            ...
            <div class="details-view adminuser-view" hidden="true" style="display: none;">
                <h2><?php echo $this->lang->line('details'); ?></h2>

                <input type="hidden" id="adminuser-id" class="record-id" />

                <div class="row-fluid">
                    <div class="adminuser-details span6">
                        <label for="adminuser-first-name"><?php echo $this->lang->line('first_name'); ?>  *</label>
                        <input type="text" id="adminuser-first-name" class="span11 required" />

                        <label for="adminuser-last-name"><?php echo $this->lang->line('last_name'); ?> *</label>
                        <input type="text" id="adminuser-last-name" class="span11 required" />

                        <label for="adminuser-email"><?php echo $this->lang->line('email'); ?> *</label>
                        <input type="text" id="adminuser-email" class="span11 required" />

                        <label for="adminuser-mobile-number"><?php echo $this->lang->line('mobile_number'); ?></label>
                        <input type="text" id="adminuser-mobile-number" class="span11" />

                        <label for="adminuser-phone-number"><?php echo $this->lang->line('phone_number'); ?> *</label>
                        <input type="text" id="adminuser-phone-number" class="span11 required" />

                        <label for="adminuser-address"><?php echo $this->lang->line('address'); ?></label>
                        <input type="text" id="adminuser-address" class="span11" />

                        <label for="adminuser-city"><?php echo $this->lang->line('city'); ?></label>
                        <input type="text" id="adminuser-city" class="span11" />

                        <label for="adminuser-state"><?php echo $this->lang->line('state'); ?></label>
                        <input type="text" id="adminuser-state" class="span11" />

                        <label for="adminuser-zip-code"><?php echo $this->lang->line('zip_code'); ?></label>
                        <input type="text" id="adminuser-zip-code" class="span11" />

                        <label for="adminuser-notes"><?php echo $this->lang->line('notes'); ?></label>
                        <textarea id="adminuser-notes" class="span11" rows="3"></textarea>
                    </div>
                    <div class="adminuser-settings span6">
...
<!--                        <input type="text" id="provider-username" class="span9 required" />-->
                        ...
                        <label for="adminuser-password"><?php echo $this->lang->line('password'); ?> *</label>
                        <input type="password" id="adminuser-password" class="span9 required"/>

                        <label for="adminuser-password-confirm"><?php echo $this->lang->line('retype_password'); ?> *</label>
                        <input type="password" id="adminuser-password-confirm" class="span9 required" />

                        <br>

                        <button type="button" id="adminuser-notifications" class="btn" data-toggle="button">
                            <i class="icon-envelope"></i>
                            <span><?php echo $this->lang->line('receive_notifications'); ?></span>
                        </button>
            ...
            <div class="working-plan-view adminuser-view" >
                <h2><?php echo $this->lang->line('time_slot'); ?></h2>

                <label for="duration"><?php echo $this->lang->line('timeslot_minutes'); ?></label>
