...
<body>
    <div id="no-priv-frame" class="frame-container">
        <h3><?php echo $this->lang->line('no_image'); ?></h3>
        <p>
<!--            --><?php //echo $this->lang->line('no_subdomain_message'); ?>
            <?php echo $error; ?>
        </p>  
        
        <br>
        
        <a href="<?php echo $this->config->item('base_url'); ?>/index.php/adminuser/profile" class="btn btn-success btn-large">
