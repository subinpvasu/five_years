<script type="text/javascript"
        src="<?php echo $base_url; ?>/assets/js/backend_user.js"></script>

<script type="text/javascript"
        src="<?php echo $base_url; ?>/assets/js/backend_users_admins.js"></script>
<script type="text/javascript"
        src="<?php echo $base_url; ?>/assets/js/backend_users_provider.js"></script>
<script type="text/javascript"
...
<!--        <li class="admins-tab tab "><a>--><?php //echo $this->lang->line('admins'); ?><!--</a></li>-->
        <li class="providers-tab tab active"><a><?php echo $this->lang->line('providers'); ?></a></li>
    ...
    <div id="providers" class="tab-content" >
        ...
        <div class="details column span7">
            <div class="btn-toolbar span5">
                <div class="add-edit-delete-group btn-group">
                    <button id="add-provider" class="btn " disabled="disabled">
                        <i class="icon-plus icon-white"></i>
                        <?php echo $this->lang->line('add'); ?>
                    </button>
