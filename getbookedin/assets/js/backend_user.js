...
var BackendUser = {
    ...
    initialize: function(defaultEventHandlers) {
        ...
        BackendUser.helper = new ProviderHelper();
        //BackendUser.helper.resetForm();
        BackendUser.helper.filter(GlobalVariables.user.email,GlobalVariables.user.id);
        
        BackendUser.wp = new WorkingPlan();
        BackendUser.wp.bindEventHandlers();
        ...
        */
        ...
        // Bind event handlers.
        if (defaultEventHandlers) BackendUser.bindEventHandlers();
    },
    ...
    bindEventHandlers: function() {
        ...
        ProviderHelper.prototype.bindEventHandlers();
