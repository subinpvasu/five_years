...
var BackendSettings = {
    ...
    bindEventHandlers: function() {
        ...
        $('.save-settings').click(function() {
            ...
            //settings.header_settings = BackendSettings.settings.getHeaderSettings();
            //////////////////////////////////////////////
        ...
        $('.save-header').click(function() {
            var header = BackendSettings.settings.getHeaderSettings();
            /////////////////////////////////////
            console.log(header);
            /////////////////////////////////////

            BackendSettings.settings.saveHeader(header);
...
UserSettings.prototype.saveHeader = function(header) {
    var postUrl = GlobalVariables.baseUrl + '/index.php/backend_api/ajax_save_header_settings';
    var postData = {
        'csrfToken': GlobalVariables.csrfToken,
        'type': BackendSettings.SETTINGS_HEADER,
