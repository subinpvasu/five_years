...
//  // $root =    $helper->createUnit(null, null, 100000);
...
//   $otherBrand = $helper->createSubdivision($otherCondition, new ProductBrand());
//   // The value for the bidding category is a fixed ID for the 'Luggage & Bags'
//   // category. You can retrieve IDs for categories from the ConstantDataService.
//   // See the 'GetProductCategoryTaxonomy' example for more details.
//   $helper->createUnit($otherBrand, new ProductBiddingCategory('BIDDING_CATEGORY_L1', '-5914235892932915235'), 750000);
//   $helper->createUnit($otherBrand, new ProductBiddingCategory('BIDDING_CATEGORY_L1'), 110000);
//   // Make the mutate request.
  $result = $adGroupCriterionService->mutate($adGroupId);
  $children = array();
  $rootNode = null;
