...
require_once "src/../".ADWORDS_UTIL_VERSION_PATH . '/ReportUtils.php';
...
function DownloadCriteriaReportExample(AdWordsUser $user, $filePath) {
  ...
  $selector->fields = array('AccountDescriptiveName', 'Conversions', 'Cost','ExternalCustomerId','Date');
...
//  $selector->predicates[] = new Predicate('Status', 'NOT_IN', array('PAUSED'));
  ...
  $reportDefinition->reportName = 'Account performance report #' . uniqid();
  $reportDefinition->dateRangeType = 'LAST_MONTH';
