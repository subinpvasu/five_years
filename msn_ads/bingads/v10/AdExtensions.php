...
use BingAds\v10\CampaignManagement\CalloutAdExtension;
use BingAds\v10\CampaignManagement\ReviewAdExtension;
...
try
{
    ...
    $encodedExtension = new SoapVar($extension, SOAP_ENC_OBJECT, 'CalloutAdExtension', $proxy->GetNamespace());
    $adExtensions[] = $encodedExtension;
    ...
    $encodedExtension = new SoapVar($extension, SOAP_ENC_OBJECT, 'ReviewAdExtension', $proxy->GetNamespace());
    $adExtensions[] = $encodedExtension;
    ...
    OutputAdExtensionsWithEditorialReasons($proxy, $adExtensions, $adExtensionEditorialReasonCollection);
...
function OutputAdExtensionsWithEditorialReasons($proxy, $adExtensions, $adExtensionEditorialReasonCollection)
{
    $index = 0;
    ...
    foreach ($adExtensions->AdExtension as $extension)
    {
    	...
    	else
    	{
    		...
    		{
    			printf("IsExact: %s\n",
    			(true == $extension->IsExact) ? "true" : "false");
                        print("Source: " . $extension->Source . "\n");
    			print("Text: " . $extension->Text . "\n");
