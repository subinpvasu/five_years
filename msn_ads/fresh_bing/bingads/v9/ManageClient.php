...
try
{
    ...
    //$agencyProxy = ClientProxy::ConstructWithCredentials($wsdl, null, null, $AgencyDeveloperToken, "AgencyAuthenticationTokenGoesHere");
    //$clientProxy = ClientProxy::ConstructWithCredentials($wsdl, null, null, $ClientDeveloperToken, "ClientAuthenticationTokenGoesHere");
