...
namespace BingAds\v10\CampaignManagement
{
    ...
    final class BiddableAdGroupCriterion extends AdGroupCriterion
    {
        ...
        /**
         * Tracking templates can be used in tandem with the URL specified in the 'Link' field for the product offer that you submitted via the Content API.
         * @var string
         */
        public $TrackingUrlTemplate;
    ...
    {
        /**
         * The list of ad group remarketing list associations that correspond directly to the ad group identifiers specified in the request.
         * @var AdGroupRemarketingListAssociation[]
         */
        public $AdGroupRemarketingListAssociations;
    ...
    /**
     * Gets the remarketing lists that the current authenticated user can access.
    ...
    {
        /**
         * A maximum of 1,000 identifiers of the remarketing lists to get.
         * @var integer[]
         */
