...
try
{
    ...
    //$GLOBALS['adInsightProxy'] = ClientProxy::ConstructWithAccountId($GLOBALS['adInsightWsdl'], null, null, $DeveloperToken, $AccountId, "AuthenticationTokenGoesHere");
    //$GLOBALS['campaignProxy'] = ClientProxy::ConstructWithAccountId($GLOBALS['campaignWsdl'], null, null, $DeveloperToken, $AccountId, "AuthenticationTokenGoesHere");
